...
class Evaluator(nn.Module):
    ...
    def forward(self, feats, last_rnn_state, pred_poly):
        ...
        inp = torch.cat([feats, last_rnn_state[0][0], last_rnn_state[1][0], pred_mask, pred_vertex_mask], dim=1)
