...
from pipeswitch.models.few_shot_detection.fsdet.checkpoint import (
    DetectionCheckpointer,
)
from pipeswitch.models.few_shot_detection.fsdet.engine.hooks import (
    EvalHookFsdet,
)
from pipeswitch.models.few_shot_detection.fsdet.evaluation import (
    DatasetEvaluator,
...
from pipeswitch.models.few_shot_detection.fsdet.utils.file_io import PathManager
...
class DefaultTrainer(SimpleTrainer):
    ...
    def build_hooks(self):
        ...
        ret.append(
            EvalHookFsdet(cfg.TEST.EVAL_PERIOD, test_and_save_results, self.cfg)
        )
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TEST):
            ...
            if evaluators is not None:
                ...
                try:
                    ...
                    logger.warn(
                        "No evaluator found. Use"
                        " `DefaultTrainer.test(evaluators=)`, or implement its"
                        " `build_evaluator` method."
                    )
