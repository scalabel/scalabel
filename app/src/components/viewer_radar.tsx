...
import RadarCanvas from "./radar_canvas"
 ...
 */
export class ViewerRadar extends DrawableViewer<Viewer2DProps> {
  ...
  /**
   * Handle double click
   * when double click, save coordinates of the click with dispacthing
   *
   * @param e
   */
...
export default withStyles(viewerStyles)(ViewerRadar)
