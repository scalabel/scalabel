...
import { TrackInterp } from '../../../js/auto/track/interp'
import { Box2DLinearInterp } from '../../../js/auto/track/linear_interp/box2d'
...
test('2D box linear interpolation', () => {
  ...
  newShape[0] = { ...newShape[0], x1: 36, y1: 72, x2: 32, y2: 44 }

  shapes = interp.interp(newLabel, newShape, labels, shapes) as RectType[][]
  expect(shapes[4][0]).toMatchObject({ x1: 36, y1: 72, x2: 32, y2: 44 })
