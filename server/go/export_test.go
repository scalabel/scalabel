...
var Box2dDataStructs = []map[string]interface{}{
	{"x": 478.7920184573, "y": 454.5838057954, "W": 173.1446443451, "H": 24.6506756705},
	{"x": 910.1114888987, "y": 699.7739185242, "W": 22.6105225649, "H": 79.6625312940},
	{"x": 857.6822839050, "y": 62.5223033165, "W": 151.5271330284, "H": 174.6097113707},
	{"x": 760.7877908042, "y": 201.4584124542, "W": 1.1209293956, "H": 142.2690489844},
	{"x": 587.6507607175, "y": 752.4520039331, "W": 132.3780017789, "H": 186.3163234249},
	{"x": 801.7192731172, "y": 46.0775615369, "W": 59.0162523807, "H": 86.5581569625},
	{"x": 29.8084527376, "y": 571.1304971125, "W": 198.8522393520, "H": 110.7235428664},
	{"x": 867.4728288827, "y": 442.8921109871, "W": 157.2019004174, "H": 165.4684783084},
	{"x": 567.0276746260, "y": 598.5596172189, "W": 68.1508588984, "H": 4.1495718779},
	{"x": 965.0563346591, "y": 636.1565779043, "W": 147.9695805767, "H": 20.8757090088},
}

var Vertices = []map[string]interface{}{
	{"id": 100, "x": 352.9180483839, "y": 48.0398192532, "type": "vertex"},
	{"id": 101, "x": 438.5795776342, "y": 194.3305046791, "type": "vertex"},
	{"id": 102, "x": 151.8652725570, "y": 554.5075538404, "type": "vertex"},
	{"id": 103, "x": 765.8384403890, "y": 587.1802841891, "type": "vertex"},
	{"id": 104, "x": 214.6648040111, "y": 228.0759932263, "type": "vertex"},
	{"id": 105, "x": 318.8972106447, "y": 486.9632853285, "type": "vertex"},
	{"id": 106, "x": 422.9682695427, "y": 251.0250404463, "type": "vertex"},
	{"id": 107, "x": 525.8007402697, "y": 14.5254923717, "type": "vertex"},
	{"id": 108, "x": 975.7559088323, "y": 326.6811136843, "type": "vertex"},
	{"id": 109, "x": 9.9677230648, "y": 360.4314506879, "type": "vertex"},
}

var ControlPoints = []map[string]interface{}{
	{"id": 200, "x": 976.2323493915, "y": 56.0409970319, "type": "control_point"},
	{"id": 201, "x": 221.3166425928, "y": 448.9519881560, "type": "control_point"},
	{"id": 202, "x": 49.3708157221, "y": 633.6111675987, "type": "control_point"},
	{"id": 203, "x": 43.7650062010, "y": 134.1869273863, "type": "control_point"},
	{"id": 204, "x": 317.9242572284, "y": 19.5803224804, "type": "control_point"},
	{"id": 205, "x": 21.0162497079, "y": 710.5064390722, "type": "control_point"},
	{"id": 206, "x": 735.0692200197, "y": 183.2300379138, "type": "control_point"},
	{"id": 207, "x": 110.2520759083, "y": 106.6929068358, "type": "control_point"},
	{"id": 208, "x": 157.3535845731, "y": 706.0231976234, "type": "control_point"},
	{"id": 209, "x": 124.7660897340, "y": 92.5270952830, "type": "control_point"},
}
...
var PolylineDataStructs = []map[string]interface{}{
	{
		...
		"Edges": []map[string]interface{}{
			{"id": 300, "src": Vertices[0]["id"], "dest": Vertices[1]["id"], "type": "line", "control_points": nil},
			{"id": 301, "src": Vertices[1]["id"], "dest": Vertices[2]["id"], "type": "line", "control_points": nil},
			{"id": 302, "src": Vertices[2]["id"], "dest": Vertices[0]["id"], "type": "line", "control_points": nil},
		},
	},

	{
		...
		"Edges": []map[string]interface{}{
			{"id": 300, "src": Vertices[0]["id"], "dest": Vertices[1]["id"], "type": "bezier",
				"control_points": []map[string]interface{}{ControlPoints[0], ControlPoints[1]}},
			{"id": 301, "src": Vertices[1]["id"], "dest": Vertices[2]["id"], "type": "bezier",
				"control_points": []map[string]interface{}{ControlPoints[2], ControlPoints[3]}},
			{"id": 302, "src": Vertices[2]["id"], "dest": Vertices[0]["id"], "type": "bezier",
				"control_points": []map[string]interface{}{ControlPoints[4], ControlPoints[5]}},
		},
	},

	{
		"id": 2,
		"Vertices": []map[string]interface{}{
			Vertices[1], Vertices[4], Vertices[2], Vertices[8], Vertices[5], Vertices[7], Vertices[9], Vertices[6], Vertices[3], Vertices[0],
		},
		"Edges": []map[string]interface{}{
			{"id": 300, "src": Vertices[1]["id"], "dest": Vertices[4]["id"], "type": "line", "control_points": nil},
			{"id": 301, "src": Vertices[4]["id"], "dest": Vertices[2]["id"], "type": "bezier",
				"control_points": []map[string]interface{}{ControlPoints[0], ControlPoints[1]}},
			{"id": 302, "src": Vertices[2]["id"], "dest": Vertices[8]["id"], "type": "line", "control_points": nil},
			{"id": 303, "src": Vertices[8]["id"], "dest": Vertices[5]["id"], "type": "bezier",
				"control_points": []map[string]interface{}{ControlPoints[2], ControlPoints[3]}},
			{"id": 304, "src": Vertices[5]["id"], "dest": Vertices[7]["id"], "type": "bezier",
				"control_points": []map[string]interface{}{ControlPoints[4], ControlPoints[5]}},
			{"id": 305, "src": Vertices[7]["id"], "dest": Vertices[9]["id"], "type": "line", "control_points": nil},
			{"id": 306, "src": Vertices[9]["id"], "dest": Vertices[6]["id"], "type": "line", "control_points": nil},
			{"id": 307, "src": Vertices[6]["id"], "dest": Vertices[3]["id"], "type": "bezier",
				"control_points": []map[string]interface{}{ControlPoints[6], ControlPoints[7]}},
			{"id": 308, "src": Vertices[3]["id"], "dest": Vertices[0]["id"], "type": "line", "control_points": nil},
			{"id": 309, "src": Vertices[0]["id"], "dest": Vertices[1]["id"], "type": "bezier",
...
var PolygonPoly2dDataStructs = []map[string]interface{}{
	...
	{"closed": true, "polys": []map[string]interface{}{PolylineDataStructs[0], PolylineDataStructs[1]}},
...
var PathPoly2dDataStructs = []map[string]interface{}{
	...
	{"closed": false, "polys": []map[string]interface{}{PolylineDataStructs[0], PolylineDataStructs[1]}},
	{"closed": false, "polys": []map[string]interface{}{PolylineDataStructs[0], PolylineDataStructs[1], PolylineDataStructs[2]}},
}
